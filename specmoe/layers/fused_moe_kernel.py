...
def stack_fused_moe(
    ...
    #     print(topk_ids)
    # print("M: ", M) # token_num
    # print("topk_ids: ", topk_ids.shape) # token_num x topk
    # print("w1: ", w1.shape)
    # print("page_size: ", page_size)
    # page_size = hidden_dimension * intermediate_size * 3
    # N = 2 * page_size // 3 // hidden_size = 2 * intermediate_size
    # print("N: ", N) # 28672, 
    # print("H: ", H) # hidden dimension: 4096
