...
import sys
sys.path.append("/home/zzh/codes/triton_cpu_test/test/examples")
from cnndailymail.loaddata import loaddata
...
if __name__ == '__main__':
    ...
    max_seq_len = args.max_seql + args.max_output_length + 25
    ...
    ROOT = "/home/zzh/codes/triton_cpu_test/test"
    solver = Solver(
    ...
    engine = SpecMoeEngine(
        ...
        profile_output_dir="/home/zzh/codes/triton_cpu_test/test/logs/profile",
